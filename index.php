  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
        <h4 class="fw-bold text-danger mb-3" data-aos="fade-right">Transformando suas ideias em projetos únicos e personalizados!</h4>
        <h1 class="hero-title" data-aos="fade-right"
        data-aos-delay="200">Venha transformar suas ideias com a Projetizeart!</h1>
        <p class="mb-4 fw-medium"  id="paragrafo"
        data-aos="fade-right"
        data-aos-delay="400">Se você busca inovação, criatividade e soluções sob medida para o seu projeto, está no lugar certo.
          Nós estamos prontos para trazer suas ideias à vida e fazer sua marca se destacar no mercado. </p>
        
        <div class="text-center text-md-start"> <a class="btn btn-primary btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow" href="#!" role="button" data-aos="fade-up">Saiba mais</a>
          <div class="w-100 d-block d-md-none"></div><a href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span class="btn btn-danger round-btn-lg rounded-circle me-3 danger-btn-shadow"> <img src="assets/img/hero/play.svg" width="15" alt="paly"/></span></a><span class="fw-medium" data-aos="fade-up"
          data-aos-delay="200">Play Demo</span>
...
<h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize" data-aos="fade-right">Oferecemos os melhores serviços!</h3>
    </div>
    <div class="row">
      <div class="col-lg-3 col-sm-6 mb-6">
        <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
          <div class="card-body p-xxl-5 p-7" data-aos="fade-right"
          data-aos-delay="300"> <img src="creativity.png" width="75" alt="Service" />
...
<section class="pt-5" id="destination">
  ...
  <div class="container">
    ...
    <div class="mb-7 text-center">
      ...
      data-aos="fade-right"
      data-aos-delay="300">Confira Alguns Produtos</h3>
    </div>
    <div class="row">
      ...
      >
        <div class="card overflow-hidden shadow"> <img class="card-img-top" src="https://i.pinimg.com/736x/10/f7/a8/10f7a849748e02e2413b903999550865.jpg" alt="Rome, Italty" />
          <div class="card-body py-4 px-3" data-aos="fade-up"
          data-aos-delay="200">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="mb-4 text-start">
          <h5 class="text-secondary"  data-aos="fade-right"
          >O Perfeito Equilíbrio entre Excelência, Rapidez e Qualidade </h5>
          <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize" data-aos="fade-right"
          data-aos-delay="200">Essas são as Etapas que fundamentam nosso negócio</h3>
        </div>
        <div class="d-flex align-items-start mb-5">
          ...
          <div class="flex-1"  data-aos="fade-in"
          data-aos-delay="400">
      ...
      <div class="col-lg-6 d-flex justify-content-center align-items-start" data-aos="fade-left"
      data-aos-delay="900">
    ...
    <div class="row">
      <div class="col-lg-5">
        <div class="mb-8 text-start">
          ...
          <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize"
          data-aos="fade-up"
          data-aos-delay="200">O que as pessoas falam sobre nós.</h3>
        </div>
      </div>
...
<input class="form-control form-little-squirrel-control" type="email" placeholder="Enter email " aria-label="email" name="email"/>
                
                <img class="input-box-icon" src="assets/img/cta/mail.svg" width="17" alt="mail"  />
              </div>
            </div>
            <div class="col-sm-auto" data-aos="fade-left"
            data-aos-delay="200">
              <button class="btn btn-danger orange-gradient-btn fs--1" type="submit" >Inscreva-se!</button>
            </div>
          </form>
        </div>
      </div>
